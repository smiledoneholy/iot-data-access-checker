...
import { AccountBar, type SessionUser } from "@/components/account-bar";
...
export function HomeShell() {
  ...
  return <main>
    <header className="border-b border-slate-800"><div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-5"><span className="font-semibold"><span className="text-cyan-400">IoT</span> Data Access Checker</span><AccountBar user={user} onUserChange={setUser} /></div></header>
